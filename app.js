...
var LayoutComponent = {
    view: function () {
        return m('.layout', m('header', m('h1.title', 'Heracles')), m('.content', m('a.button', { href: '#/entrainement' }, m('span.text', 'Entrainement'))));
    }
};
var EntrainementDashboard = {
    view: function () {
        return m('.layout', m('header.accent', m('.leftActions', m('a', { href: '#/' }, m('span.entypo-left-open.backBtn'))), m('h1.title', 'Entrainement'), m('.rightActions', [])), m('.content', m('p', 'Dashboard')));
    }
};
m.route.prefix('#');
